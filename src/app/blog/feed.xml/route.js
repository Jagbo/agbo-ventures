...
export async function GET(req) {
  ...
  let feed = new Feed({
    title: 'The AGBO Ventures Blog',
    description:
      'Stay informed with insights, news, and stories from our portfolio of innovative brands driving African growth.',
    author: {
      name: 'AGBO Ventures',
      email: 'hello@agboventures.com',
    },
    id: siteUrl,
    link: siteUrl,
